Array.prototype.nimmsort = function(fn) {
  ...
  while (
    ((subject1 = subjects.shift()),
    (subject2 = subjects.shift()),
    (x1 = subjects.shift()),
    (x2 = subjects.shift()))
  ) {
    if (x2 > target.length - 1) break;
...
Array.prototype.nimmjoin = function(...args) {
  ...
  switch (args.length) {
    case 1:
      ...
      trans = function(a, b, ia, bi) {
        return a;
      };
      break;
    case 2:
      equiv =
        _equiv_str.constructor == String
          ? function(a, b) {
  ...
  this.forEach(function(a, ia) {
    reflection.forEach(function(b, ib) {
      equiv(a, b, ia, ib) && out.push(trans(a, b, ia, ib));
    });
  });
  return out;
};
...
Array.prototype.nimmdistinct = function(...args) {
  ...
  this.forEach(function(a, ai) {
    ...
    res === false && out.push(a);
  });
  return out;
};
if (!Array.prototype.nimmdictionary)
  Array.prototype.nimmdictionary = function(key) {
    const dict = this.reduce((p, c) => {
      return {
        ...p,
        [c[key]]: [...(p[c[key]] || []), c]
      };
